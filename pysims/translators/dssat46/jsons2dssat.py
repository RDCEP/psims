...
class DSSATXFileOutput:
    ...
    def __init__(self, exp_file, soil_file, version, cul_file, eco_file, use_ptransfer = True): # need soil file for initial soil conditions
    ...
    def toXFile(self):
        ...
        for i in range(nexp):
 		...
 		sq_data['trno'] = str((int(sq_data['trno']) - 1) % 999 + 1)
                x_str += for_field(sq_data, 'trno', '1', 0, 'r', 2, jtfy = 'l') + \
                         ...
                         for_str(str(cu_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(fl_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(sa_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(ic_num), 1, 'r', 2, jtfy = 'l') + \
			 for_str(str(mp_num), 1, 'r', 2, jtfy = 'l') + \
			 for_str(str(mi_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(mf_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(mr_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(mc_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(mt_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(me_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(mh_num), 1, 'r', 2, jtfy = 'l') + \
                         for_str(str(sm_num), 1, 'r', 2, jtfy = 'l') + '\n'
        ...
        if cu_arr != []:
            ...
            for i in range(len(cu_arr)):
                ...
                x_str += for_str(str(i + 1), 0, 'r', 2, jtfy = 'l') + \
        ...
        for i in range(len(fl_arr)):
            ...
            event_part2 += for_str(str(i + 1), 0, 'r', 2, jtfy = 'l') + \
...
class Jsons2Dssat(translator.Translator):
    ...
    def run(self, latidx, lonidx):
        try:
            ...
            xfileoutput = DSSATXFileOutput(efile, sfile, version, CULfile, ECOfile, use_ptransfer = pfcn)
